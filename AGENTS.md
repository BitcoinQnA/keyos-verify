...
Full-width action buttons use `ControlSize.md` (60px in the app theme). Secondary and destructive
variants keep that same size. Compact inline file-picker buttons and algorithm selectors may use
`ControlSize.sm`. Run `tests/test_ui_style.py` and the UI previews after changing buttons.
